 ...
 */
class MemcacheSession extends MemcacheWrapper implements SessionInterface {
    ...
    /** @var MemcacheCache $handler Session handler */
    protected $handler;
     ...
     * Add a handler
     *
     * @param MemcacheCache $handler
     */
    public function setHandler(MemcacheCache $handler) {
